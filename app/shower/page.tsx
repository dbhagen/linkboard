    ...
    >
      <InvitationText>
        ...
        <InvitationScript $size="lg">
          Baby Blue Brunch &amp; Shower
        </InvitationScript>
        <InvitationDetail $size="sm">A ladies-only celebration</InvitationDetail>
        <InvitationDivider />
        <InvitationScript>Honoring the Mommy-to-be</InvitationScript>
        <InvitationDetail $size="lg" $bold>
          Kirsten Johnson Hagen
        </InvitationDetail>
        <InvitationDivider />
        <InvitationDetail $bold>Saturday, March 7th</InvitationDetail>
        <InvitationDetail $size="sm">
          11-11:30am Mingle and Select Your Meal
        </InvitationDetail>
        <InvitationDetail $size="sm">
          11:30am-1pm Seated Brunch
        </InvitationDetail>
        <InvitationDivider />
        <InvitationLink
          href="https://maps.app.goo.gl/2prLLgig7Sd6TLSV6"
          target="_blank"
